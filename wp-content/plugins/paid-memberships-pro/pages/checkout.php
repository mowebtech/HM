		...
		<tr>
			<td>
				<div>
					...
					<input id="username" name="username" type="text" class="input <?php echo pmpro_getClassForField("username");?>"  value="<?php echo esc_attr($username)?>" /> 
				</div>
				...
				<div>
					...
					<input id="bemail" name="bemail" type="text" class="input <?php echo pmpro_getClassForField("bemail");?>"  value="<?php echo esc_attr($bemail)?>" /> 
				</div>
				<?php
					...
					<div>
						...
						<input id="bconfirmemail" name="bconfirmemail" type="text" class="input <?php echo pmpro_getClassForField("bconfirmemail");?>"  value="<?php echo esc_attr($bconfirmemail)?>" /> 
				...
				<div class="pmpro_hidden">
					...
					<input id="fullname" name="fullname" type="text" class="input <?php echo pmpro_getClassForField("fullname");?>"  value="" /> <strong>LEAVE THIS BLANK</strong>
				</div>				
		...
		<tr>
			<td>
				<div>
					...
					<input id="bfirstname" name="bfirstname" type="text" class="input <?php echo pmpro_getClassForField("bfirstname");?>"  value="<?php echo esc_attr($bfirstname)?>" /> 
				</div>	
				<div>
					<label for="blastname">Last Name</label>
					<input id="blastname" name="blastname" type="text" class="input <?php echo pmpro_getClassForField("blastname");?>"  value="<?php echo esc_attr($blastname)?>" /> 
				</div>					
				<div>
					<label for="baddress1">Address 1</label>
					<input id="baddress1" name="baddress1" type="text" class="input <?php echo pmpro_getClassForField("baddress1");?>"  value="<?php echo esc_attr($baddress1)?>" /> 
				</div>
				<div>
					<label for="baddress2">Address 2</label>
					<input id="baddress2" name="baddress2" type="text" class="input <?php echo pmpro_getClassForField("baddress2");?>"  value="<?php echo esc_attr($baddress2)?>" />
				</div>
				...
				?>
					<div>
						...
						<input id="bcity" name="bcity" type="text" class="input <?php echo pmpro_getClassForField("bcity");?>"  value="<?php echo esc_attr($bcity)?>" /> 
					</div>
					<div>
						<label for="bstate">State</label>																
						<input id="bstate" name="bstate" type="text" class="input <?php echo pmpro_getClassForField("bcity");?>"  value="<?php echo esc_attr($bstate)?>" /> 					
					</div>
					<div>
						<label for="bzipcode">Zip/Postal Code</label>
						<input id="bzipcode" name="bzipcode" type="text" class="input <?php echo pmpro_getClassForField("bzipcode");?>"  value="<?php echo esc_attr($bzipcode)?>" /> 
					</div>					
				<?php
					}
					else
					...
					<div>
						...
						<input id="bcity" name="bcity" type="text" class="input <?php echo pmpro_getClassForField("bcity");?>" size="9" value="<?php echo esc_attr($bcity)?>" />, 
						<?php
						...
						?>
						<input id="bzipcode" name="bzipcode" type="text" class="input <?php echo pmpro_getClassForField("bzipcode");?>" size="1" value="<?php echo esc_attr($bzipcode)?>" /> 
					</div>
					<?php
					}
				?>
				...
				<div>
					...
					<input id="bphone" name="bphone" type="text" class="input <?php echo pmpro_getClassForField("bphone");?>" size="20" value="<?php echo esc_attr($bphone)?>" /> 
