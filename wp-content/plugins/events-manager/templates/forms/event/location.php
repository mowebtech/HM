...
<div id="em-location-data">
	...
	<?php else : ?>
	<table style="float: none;" class="em-location-data">
		<?php 
			global $EM_Location;
		...
		?>
		<tr>
			<td><label><?php echo $required; ?><?php _e ( 'Location Name:', 'dbem' )?></label></td>
			<td>
				<input id='location-id' name='location_id' type='hidden' value='<?php echo $EM_Location->location_id; ?>' size='15' />
				<input id="location-name" type="text" name="location_name" value="<?php echo htmlspecialchars($EM_Location->location_name, ENT_QUOTES); ?>" />									
		...
		<tr>
			<td><?php echo $required; ?><?php _e ( 'Address:', 'dbem' )?>&nbsp;</td>
			<td>
				<input id="location-address" type="text" name="location_address" value="<?php echo htmlspecialchars($EM_Location->location_address, ENT_QUOTES); ; ?>" />
			</td>
		</tr>
		<tr>
			<td><?php echo $required; ?><?php _e ( 'City/Town:', 'dbem' )?>&nbsp;</td>
			<td>
				<input id="location-town" type="text" name="location_town" value="<?php echo htmlspecialchars($EM_Location->location_town, ENT_QUOTES); ?>" />
			</td>
		</tr>
		<tr>
			<td><?php _e ( 'State/County:', 'dbem' )?>&nbsp;</td>
			<td>
		...
		<tr>
			<td><?php echo $required; ?><?php _e ( 'Country:', 'dbem' )?>&nbsp;</td>
			<td>
		...
		<tr>
			...
			<td>
				<div id="">	
					<!-- 
					<a href="" style='position:absolute;margin-left:-20px;z-index:1000;' >[X]</a>
					-->
