		...
		<?php
                ...
                function my_em_styles_search_form(){ 
                    ...
                    if( !isset($_REQUEST['event_types']) ){
                        $event_types = '';
                    }elseif( !empty ($_REQUEST['event_types']) ){
                        $event_types = $_REQUEST['event_types']; 
                    }
                    ...
                    //    $my_em_styles = (is_array(get_option('my_em_styles'))) ? get_option('my_em_styles'):array();
                       ?>
                        ...
                        <!-- START Styles Search -->
                       <!--  Style: <input type="text" name="event_styles" value="<?php echo $event_styles; ?>" />  -->
                        
                <select name="event_types">
			<option value="">All types</option>
			<option <?php if($event_types == "try") echo 'selected=selected'; ?> value="try">Try</option>
			<option <?php if($event_types == "spectate") echo 'selected=selected'; ?> value="spectate">Spectate</option>
			<option <?php if($event_types == "participate") echo 'selected=selected'; ?> value="participate">Participate</option>
			<option <?php if($event_types == "meet") echo 'selected=selected'; ?> value="meet">Meet</option>
		    </select>
